...
public static class VehicleSeed
{
    ...
    [
        ...
        Vehicle(5, "현대", "아반떼", "가솔린, 하이브리드, LPG", "준중형"),
        ...
        Vehicle(25, "쉐보레", "트렉스 크로스오버", "가솔린", "소형SUV"),
        Vehicle(26, "쉐보레", "트레일블레이저", "가솔린", "소형SUV"),
        Vehicle(27, "KGM", "티볼리", "가솔린", "소형SUV"),
        Vehicle(28, "르노코리아", "아르카나", "가솔린", "소형SUV"),
        ...
        Vehicle(34, "쉐보레", "이쿼녹스", "가솔린", "준중형SUV / 5인"),
        Vehicle(35, "KGM", "액티언", "가솔린", "준중형SUV / 5인"),
        Vehicle(36, "KGM", "토레스", "가솔린", "준중형SUV / 5인"),
        ...
        Vehicle(43, "KGM", "렉스턴", "가솔린", "중형SUV / 5, 6, 7인승"),
        Vehicle(44, "르노코리아", "그랑 콜레오스", "가솔린", "중형SUV / 5, 6, 7인승"),
        ...
        Vehicle(49, "르노코리아", "필랑트", "가솔린", "대형SUV / 내연: 7, 9인승 / 전기: 6, 7인승"),
